  ...
  methods: {
    ...
    updateCart(data) {
      ...
      this.$http.put(url, { data: cart }).then((res) => {
        this.$$httpMessage(res, 'update cart');
        this.isLoading = false;
        this.getCart();
      });
    },
    addCouponCode() {
      ...
      this.$http.post(url, { data: coupon }).then((res) => {
        this.$$httpMessage(res, 'add coupon');
        this.isLoading = false;
        this.getCart();
      });
    },
    createOrder() {
      ...
      this.$http.post(url, { data: order }).then((res) => {
        this.$httpMessage(res, 'create order');
        if (res.data.success) {
    ...
    deleteAllCarts() {
      ...
      this.$http.delete(url).then((res) => {
        if (res.data.success) {
          this.$httpMessage(res, 'clear carts');
          this.getCart();
          this.isLoading = false;
        } else {
          this.$httpMessage(res, 'clear carts');
    ...
    removeCartItem(id) {
      ...
      this.$http.delete(url).then((res) => {
        if (res.data.success) {
          this.$httpMessage(res, 'remove cart item');
          this.status.loadingItem = '';
          this.isLoading = false;
          this.getCart();
        } else {
